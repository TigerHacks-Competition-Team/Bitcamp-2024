...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style={`width: ${size}px`} class={className} 
	><g data-name="Layer 2"
		><g data-name="log-in"
			><rect width="24" height="24" transform="rotate(-90 12 12)" opacity="0" /><path
				d="M19 4h-2a1 1 0 0 0 0 2h1v12h-1a1 1 0 0 0 0 2h2a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1z" fill={color}
			/><path fill={color}
